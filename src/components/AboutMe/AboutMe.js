          ...
          <div className="about-me__info">
            <div className="about-me__info-container">
              ...
              <p className="about-me__description landing__paragraph">
                ...
                HR в сфере обучения персонала, а потом решила все поменять и
                найти более интересную профессию. Теперь я пишу код для
                фронтенда и мне это безумно нравится! А еще я увлекаюсь йогой и
